...
function createWindow () {
  ...
  // DevTools disabled by default; uncomment next line to enable in dev
...
// Helper
function listChallenges() { return store.get('challenges'); }
function saveChallenges(challenges) { store.set('challenges', challenges); }
